...
public final class MascFrame extends javax.swing.JFrame {
    ...
    public MascFrame() {
        ...
        jLabel11.setIcon(new javax.swing.ImageIcon(".\\src\\Icons\\faculdade.png"));
    ...
    public void setPeriodoLabel(JLabel PeriodoLabel) {
    ...
    public JProgressBar getProgressoProgressBar() {
        return ProgressoProgressBar;
    }

    public void setProgressoProgressBar(JProgressBar ProgressoProgressBar) {
        this.ProgressoProgressBar = ProgressoProgressBar;
    }
    ...
    public JProgressBar getTedioProgressBar() {
        return TedioProgressBar;
    }

    public JProgressBar getFamaProgressBar() {
        return FamaProgressBar;
    }

    public void setFamaProgressBar(JProgressBar FamaProgressBar) {
        this.FamaProgressBar = FamaProgressBar;
    }

    public JProgressBar getForcaProgressBar() {
        return ForcaProgressBar;
    }

    public void setForcaProgressBar(JProgressBar ForcaProgressBar) {
        this.ForcaProgressBar = ForcaProgressBar;
    }

    public void setTedioProgressBar(JProgressBar TedioProgreesBar) {
        this.TedioProgressBar = TedioProgreesBar;
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Fome:");

        jLabel3.setText("Sede:");

        jLabel4.setText("Estoque de Comida:");
        ...
        jButton17.setText("Cantar as Garotinhas");
        ...
        jButton24.setText("Cantar as Garotinhas");
        ...
        jButton27.setText("Virar Presidente");
    ...
    private void jButton28ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton28ActionPerformed
        verificarMorte();
        if(!this.isNamorada()){
            JOptionPane.showMessageDialog(null,"Você não tem uma namorada!\nTururu", "Erro", JOptionPane.ERROR_MESSAGE);
        }
        else{
            JOptionPane.showMessageDialog(null,"Você passou um bom tempo com a " + getNamorada1() + ".\n [Tédio-15]", "Mensagem", JOptionPane.INFORMATION_MESSAGE);
            TedioProgressBar.setValue(TedioProgressBar.getValue()-15);
        }
        atualizarJanela();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        verificarMorte();
        if("Programador da Riot Games".equals(this.getTrabalho())){
            ...
            if(input1String.equalsIgnoreCase(this.getCurso())){
                ...
                if(null != getCurso())switch (getCurso()) {
                    ...
                    this.setTrabalho("Programador da Riot");
                    break;
                    case "Desing":
                    this.setTrabalho("Design de Jogos da Riot");
                    break;
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        if("Caixa do Supermercado".equals(this.getTrabalho())){
            ...
            JOptionPane.showMessageDialog(null, "O supermercado te contrata e te oferece um salário mediano.[Dinheiro+3]",  "Mensagem", JOptionPane.INFORMATION_MESSAGE);
            this.setDinheiro(this.getDinheiro()+3);
            this.setTrabalho("Caixa do Supermercado");
            this.setExperiencia(0);
        }
        else{
            JOptionPane.showMessageDialog(null, "Você não tem experiência suficiente no trabalho anterior para conseguir essa vaga.", "Mensagem", JOptionPane.ERROR_MESSAGE);
        }
        atualizarJanela();
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        if("Lavador de Carros".equals(this.getTrabalho())){
            ...
            JOptionPane.showMessageDialog(null, "Luiz te chama pra trabalhar com ele e te dá um pequeno salário.[Dinheiro+2]", "Mensagem", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        if(null != this.getTrabalho())switch (this.getTrabalho()) {
            ...
            this.setExperiencia(this.getExperiencia()+1);
            break;
            case "Programador da Riot Games":
            verificarMorte();
            TedioProgressBar.setValue(TedioProgressBar.getValue()+20);
    ...
    private void jButton17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton17ActionPerformed
        verificarMorte();
        if(ForcaProgressBar.getValue()< 50){
            JOptionPane.showMessageDialog(null, "As garotinhas riram da sua cantada, você fracassou.", "Mensagem", JOptionPane.INFORMATION_MESSAGE);
        }
        else if(ForcaProgressBar.getValue()<80 && ForcaProgressBar.getValue()>= 50)
        {
            JOptionPane.showMessageDialog(null, "As garotinhas te deram bola, você é o cara.", "Mensagem", JOptionPane.INFORMATION_MESSAGE);
        }
        else{
            int resposta = JOptionPane.showConfirmDialog(null,"Uma garota da academia te chama pra sair.\n Aceita?","Mensagem",JOptionPane.YES_NO_OPTION);
    ...
    private void jButton31ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton31ActionPerformed
        ...
        if(MarceleProgressBar.getValue()<100){
            if(input1String.equalsIgnoreCase("Vem sempre aqui?")){
                JOptionPane.showMessageDialog(null, "Ela te responde que só vem quando você não está.\nNão desista, gafanhoto", "Mensagem", JOptionPane.INFORMATION_MESSAGE);
            }
            else if(input1String.equalsIgnoreCase("Você é o ovo que falta na minha marmita")){
                JOptionPane.showMessageDialog(null, "Ela ri e começa a te dar bola.\n[Relacionamento+10]", "Mensagem", JOptionPane.INFORMATION_MESSAGE);
                ...
                JOptionPane.showMessageDialog(null, "Ela ri e diz que gostou da ideia.\n[Relacionamento+20]", "Mensagem", JOptionPane.INFORMATION_MESSAGE);
                ...
                JOptionPane.showMessageDialog(null, "Ela fica séria e diz que não vai te dar um fora.\n[Relacionamento+20]", "Mensagem", JOptionPane.INFORMATION_MESSAGE);
                MarceleProgressBar.setValue(MarceleProgressBar.getValue()+20);
            }
        }
        else{
            if("Solteiro".equals(getStatusS())){
                int resposta1 = JOptionPane.showConfirmDialog(null,"As cantadas dão certo e surge uma oportunidade.\n Pedir Marcele em namoro?","Mensagem",JOptionPane.YES_NO_OPTION);
                if(resposta1 == JOptionPane.YES_OPTION){
                    this.setStatusS("Namorando");
                    this.setNamorada(true);
                    this.setNamorada1("Marcele");
    ...
    private void jButton24ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton24ActionPerformed
        ...
        if(!isAtletica()){
            if(FamaProgressBar.getValue()>=50){
                int resposta = JOptionPane.showConfirmDialog(null,"A galera vê que você é sinistro e te chama pra participar da Atlética.\n Aceita?","Mensagem",JOptionPane.YES_NO_OPTION);

                if(resposta == JOptionPane.YES_OPTION){
                    if("Namorando".equals(getStatusS())){
                        JOptionPane.showMessageDialog(null, "Não é legal cantar outras garotas enquanto namora.\n[Relacionamento-10]", "Mensagem", JOptionPane.INFORMATION_MESSAGE);
                        MarceleProgressBar.setValue(MarceleProgressBar.getValue()-10);

                        if(MarceleProgressBar.getValue()==0){
                            JOptionPane.showMessageDialog(null, "Marcele terminou com você.\nTururu", "Mensagem", JOptionPane.INFORMATION_MESSAGE);
                            this.setStatusS("Solteiro");
                        ...
                        JOptionPane.showMessageDialog(null, "As garotinhas te deram bola, você é sinistro.", "Mensagem", JOptionPane.INFORMATION_MESSAGE);
                    }
                }
            }
            else{
                JOptionPane.showMessageDialog(null, "Você não faz parte da atlética, tente ficar famoso.", "Mensagem", JOptionPane.ERROR_MESSAGE);
            }
        }
    ...
    private void jButton18ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton18ActionPerformed
        if(!isAtletica()){
            if(FamaProgressBar.getValue()>=20){
                ...
                if(resposta == JOptionPane.YES_OPTION){
                    JOptionPane.showMessageDialog(null, "Você virou um garoto de Atlética. \n [Fama+10]", "Prabéns", JOptionPane.INFORMATION_MESSAGE);
                    FamaProgressBar.setValue(FamaProgressBar.getValue()+10);
                    setAtletica(true);
                }
            }
            else{
                JOptionPane.showMessageDialog(null, "Você não tem fama suficiente para ser um garoto da atlética.", "Erro", JOptionPane.ERROR_MESSAGE);
            }
        }
        else{
    ...
    private void jButton27ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton27ActionPerformed
        ...
        if(!isAtletica()){
            ...
            JOptionPane.showMessageDialog(null, "Você não tem fama suficiente pra se tornar o Presidente da Atlética.", "Erro", JOptionPane.ERROR_MESSAGE);
        }
        atualizarJanela();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MascFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    void enviaNome(Simulador aThis, String nomeS) {
        this.setName(nomeS);
        NameLabel.setText(getName());
    }
}
